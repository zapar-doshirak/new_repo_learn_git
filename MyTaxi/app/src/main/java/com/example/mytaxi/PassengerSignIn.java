...
public class PassengerSignIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(auth.getCurrentUser() != null){
            startActivity(new Intent(PassengerSignIn.this, DriverMapsActivity.class));
        }
    ...
    private boolean validatePassword(){
        ...
        if (passwordInput.isEmpty()){
            ...
            textInputName.setError("Password length have to be more than 6");
            return false;
        } else {
            textInputName.setError("");
            return true;
    ...
    private boolean validateConfirmPassword(){
        ...
        if(!passwordInput.equals(confirmPasswordInput)){
            textInputName.setError("Passwords have to match");
            return false;
        } else {
            textInputName.setError("");
            return true;
